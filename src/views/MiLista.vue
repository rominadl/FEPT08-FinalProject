<template>
  ...
  <div class="container mx-auto py-8 min-h-screen">
    ...
    <p class="w-28 uppercase font-bold rounded-md px-6 py-3 bg-slate-200 hover:bg-green-800 hover:text-slate-200"><router-link to="/Buscador">Volver</router-link></p>
    <!-- titulo  -->

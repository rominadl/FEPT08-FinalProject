<template>
    ...
    >
      ...
      <div class="flex gap-10">
        ...
        >
          <h2 class="font-semibold">📍 {{this.location}} Restaurants</h2>
          ...
          <div v-if="restaurants">
            ...
            >
              <p>
                ...
                {{ business.name }} </span><br />
                <span class="text-sm">⭐️ {{ business.rating }} </span>
                <span class="text-sm"> 💰{{ business.price }} </span><br />
                <span class="text-sm">{{ business.location.display_address[0] }}, {{ business.location.display_address[1] }}, {{ business.location.display_address[2] }}</span><br />

                <a :href="business.url" target="_blank" class="text-sm text-blue-500 underline"> Ver más detalles
                </a>
  ...
  export default {
    ...
    computed: {
      ...
      totalPages() {
        ...
        return Math.ceil(this.restaurants.businesses.length / this.resultsPerPage);
      },
    },
